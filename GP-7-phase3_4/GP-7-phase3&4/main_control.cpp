...
main_control::main_control( string func_31, string func_71,string opcode)
{
        this->opcode=opcode;
       func_3=func_31;
       func_7=func_71;
    ...
    //    return ;
    B2.mem_write= Mem_write();
     //cout<<"hello_guru";
      //cout<<"mem_write:"<<mem_write<<endl;
    B2.reg_write=regwrite();
    //cout<<"In alu reg_write^^^^"<<B2.reg_write<<endl;
    B2.mem_Read=Mem_read();
       //cout<<"mem_read"<<mem_read<<endl;
    B2.MeM_to_reg=MemtoReg();
