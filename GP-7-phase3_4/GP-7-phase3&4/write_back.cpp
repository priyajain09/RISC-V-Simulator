...
void write_back() {
	...
	cout<<"IN Write Back----------"<<endl;
	unsigned int instruction_word=B4.instruction_wrd;
	...
	string imm2;
	string imm1;
	string opcode=B4.opcode;
	string funct3=B4.func3;
	int ry=B4.RY;
	int RB=B4.RB;
	//cout<<"ry---------: "<<ry<<endl;//*///changed;
	//cout<<"&&&&&&&&&&& REG_WRITE: "<<B4.reg_write<<endl;
	if(B4.reg_write==1)
	{
		//cout<<"i am in reg write hu h u hu huhuhuhuhuh"<<endl;
		//here also changed;
		//int ry=B4.RY;
	//int RB=B4.RB;
	//cout<<"ry---------: "<<ry<<endl;
